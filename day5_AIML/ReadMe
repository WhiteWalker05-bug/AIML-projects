...
initially when we call the class BankAccount outside the class and create the object , the init constructor runs. It takes the owner and balance as parameters and stores them using self.owner and self.balance
